...
old_url: "http://simpable.com/software/the-best-isapi-filter/"
graffitiID: "110"
rawDate: "1/16/2007 3:07:29 PM"
tags: [tools, open-source, isapi-filters, seo]
---


I "mentioned earlier today":http://scottwater.com/blog/archive/the-journalist-and-other-goodies/ how happy I was with "ISAPI_rewrite":http://www.isapirewrite.com/. "Kevin Harder":http://kevinharder.com/ pointed out an open source alternative that I had not heard of before called "Ionic's ISAPI Rewrite Filter":http://cheeso.members.winisp.net/IIRF.aspx (IIRF).
...
*Update:* A couple of people contacted me about "UrlRewriter.net":http://UrlRewriter.net which looks to be a very nice open source project which does some of the same things as an ISAPI filter. Definelty something to keep in mind in the future. The downside with this approach is that all requests go through the aspnet_isapi which is something I was trying to avoid.
