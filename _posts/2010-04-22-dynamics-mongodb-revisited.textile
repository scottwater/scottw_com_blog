...
permalink: /dynamics-mongodb-revisited
tags: [mongodb, dynamics, csharp]
---

A couple of months ago I wrote about wiring up "C# 4.0 dynamics with MongoDB":http://scottw.com/mongodb-dynamics. At the time, I opened up the "MongoDB-CSharp":http://github.com/samus/mongodb-csharp library and modified a bit of the code.
